...
with sqlite3.connect("users.db") as connection:
    ...
    # Create the table
    c.execute("CREATE TABLE users(user_id integer primary key, email TEXT, username TEXT, password TEXT, phone number TEXT)")
    # Create users and dummy passwords
    #c.execute('INSERT INTO users VALUES(1, "kerhsawk5646@student.faytectcc.edu","Kershawk5646", "P@ssword1", "3605212607")')
